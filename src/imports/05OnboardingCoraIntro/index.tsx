import svgPaths from "./svg-xttoj3l80n";
import imgHands from "../hands.png";
...
function ProgressBar() {
  return (
    <div className="absolute h-[8px] left-[5px] top-[479px] w-[173px]" data-name="Progress Bar">
      ...
      <div className="absolute bg-[#dd692c] h-[5px] left-[90px] rounded-[11px] top-0 w-[26px]" data-name="Progress Segment" />
    </div>
  );
}
  ...
  return (
    <div className="-translate-x-1/2 [word-break:break-word] absolute content-stretch flex flex-col gap-[24px] items-start justify-center leading-[0] left-[calc(50%-11.5px)] top-[509px] w-[320px]" data-name="Header Section">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] flex flex-col font-['Urbanist:Medium',sans-serif] font-medium h-[27px] justify-center min-w-full relative shrink-0 text-[#dd692c] text-[36px] w-[min-content]">
        <p className="leading-[42px]">In it together</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#434343] text-[16px] w-[302px]">
        <p className="leading-[21.8px]">{`Follow your loved one's readings in real time and know they're okay.`}</p>
      </div>
    </div>
  );
}
...
function ContinueWithAppleContainer() {
  return (
    <div className="content-stretch flex gap-px items-center relative shrink-0" data-name="Continue with Apple Container">
...
function ContinueWithApple() {
  return (
    <div className="absolute bg-[#0b0a0a] content-stretch flex flex-col items-center justify-center left-0 overflow-clip px-[94px] py-[13px] rounded-[41px] top-[634px] w-[353px]" data-name="Continue with Apple">
...
export default function Component05OnboardingCoraIntro({ onGoogleClick }: { onGoogleClick?: () => void } = {}) {
  return (
    <div className="relative rounded-[44px] size-full" data-name="05 · Onboarding — Cora intro">
      <img alt="" className="absolute inset-0 size-full object-cover rounded-[44px] pointer-events-none" src={imgHands} />
