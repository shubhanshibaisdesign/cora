import svgPaths from "./svg-01uh8bv0zi";
import imgFrame8217 from "./f602ce354977b09d0217706dbe5610bd8b993ccd.png";
...
function ContentArea() {
  return (
    <div className="absolute h-[745px] left-[20px] top-[60px] w-[353px]" data-name="ContentArea">
      <DeviceVideo />
...
function Frame() {
  return (
    <div className="h-[852px] overflow-clip relative shrink-0 w-[393px]">
      ...
      <div className="absolute h-[47px] left-0 overflow-clip top-0 w-[393px]" data-name="StatusBar">
        <Notch />
        <LeftSide />
        <RightSide />
      </div>
...
export default function Component09SetupProfile() {
  return (
    <div className="bg-[#fafafa] relative rounded-[44px] size-full" data-name="09 · Setup - Profile">
