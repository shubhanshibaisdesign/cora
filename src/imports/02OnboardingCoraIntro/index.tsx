import svgPaths from "./svg-c0g2qpr92c";
...
import frontVideo from "../front.mp4";
...
function ProgressBar() {
  return (
    <div className="absolute h-[5px] left-[5px] top-[479px] w-[116px]" data-name="Progress Bar">
...
function HeaderSection() {
  return (
    <div className="-translate-x-1/2 [word-break:break-word] absolute content-stretch flex flex-col gap-[24px] items-start justify-center leading-[0] left-1/2 top-[509px] w-[343px]" data-name="Header Section">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] flex flex-col font-['Urbanist:Medium',sans-serif] font-medium h-[27px] justify-center min-w-full relative shrink-0 text-[#dd692c] text-[36px] w-[min-content]">
        <p className="leading-[42px]">This is Cora</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#434343] text-[16px] w-[225px]">
        <p className="leading-[21.8px]">A soft patch that quietly reads your body all day.</p>
      </div>
    </div>
  );
}
...
function GoogleButtonContent() {
  return (
    <div className="content-stretch flex gap-[4px] items-center justify-center relative shrink-0" data-name="Google Button Content">
...
function GoogleButton({ onClick }: { onClick?: () => void }) {
  return (
    <div onClick={onClick} className="absolute bg-[#fdfdfd] content-stretch flex flex-col items-center justify-center left-0 overflow-clip px-[96px] py-[17px] rounded-[41px] top-[694px] w-[353px] cursor-pointer" data-name="Google Button">
      <GoogleButtonContent />
    </div>
  );
}
...
function AppleButtonContent() {
  return (
    <div className="content-stretch flex gap-px items-center relative shrink-0" data-name="Apple Button Content">
      <div className="h-[24px] relative shrink-0 w-[23px]" data-name="applelogo">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgApplelogo} />
      </div>
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#fdfdfd] text-[12px] text-center whitespace-nowrap">
...
function AppleButton() {
  return (
    <div className="absolute bg-[#0b0a0a] content-stretch flex flex-col items-center justify-center left-0 overflow-clip px-[94px] py-[13px] rounded-[41px] top-[634px] w-[353px]" data-name="Apple Button">
      <AppleButtonContent />
    </div>
  );
}
...
export default function Component02OnboardingCoraIntro({ onGoogleClick }: { onGoogleClick?: () => void } = {}) {
  return (
    <div className="relative rounded-[44px] size-full" data-name="02 · Onboarding — Cora intro">
      <video autoPlay muted loop playsInline className="absolute inset-0 size-full object-cover rounded-[44px] pointer-events-none" src={frontVideo} />
