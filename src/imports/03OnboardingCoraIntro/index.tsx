import svgPaths from "./svg-kpfs12n7j5";
  ...
  return (
    <div className="-translate-x-1/2 [word-break:break-word] absolute content-stretch flex flex-col gap-[24px] items-start justify-center leading-[0] left-[calc(50%-11.5px)] top-[509px] w-[320px]" data-name="Header Section">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] flex flex-col font-['Urbanist:Medium',sans-serif] font-medium h-[27px] justify-center min-w-full relative shrink-0 text-[#dd692c] text-[36px] w-[min-content]">
        <p className="leading-[42px]">Beyond the checkup</p>
      </div>
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#434343] text-[16px] w-[293px]">
        <p className="leading-[21.8px]">Reading your body continuously, catching changes as they happen.</p>
      </div>
    </div>
  );
}
...
export default function Component03OnboardingCoraIntro({ onGoogleClick }: { onGoogleClick?: () => void } = {}) {
  return (
    <div className="relative rounded-[44px] size-full" data-name="03 · Onboarding — Cora intro">
      <video autoPlay muted loop playsInline className="absolute inset-0 size-full object-cover rounded-[44px] pointer-events-none" src={backVideo} />
