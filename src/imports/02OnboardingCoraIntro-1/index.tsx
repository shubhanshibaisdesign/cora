import svgPaths from "./svg-luyjcppsay";
...
function GoogleButton() {
  return (
    <div className="absolute bg-[#fdfdfd] content-stretch flex flex-col items-center justify-center left-0 overflow-clip px-[96px] py-[17px] rounded-[41px] top-[694px] w-[353px]" data-name="Google Button">
      <GoogleButtonContent />
    </div>
  );
}
...
export default function Component02OnboardingCoraIntro() {
  return (
    <div className="relative rounded-[44px] size-full" data-name="02 · Onboarding — Cora intro">
      ...
      <div className="content-stretch flex flex-col gap-[13px] items-center justify-center overflow-clip px-[20px] relative rounded-[inherit] size-full">
        ...
        <ContentArea />
        <div className="h-[34px] relative shrink-0 w-[373px]" data-name="HomeIndicator">
