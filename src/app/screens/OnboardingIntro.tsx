...
import Component01OnboardingCoraIntro from "../../imports/01OnboardingCoraIntro";
...
export default function OnboardingIntro() {
  ...
  useEffect(() => {
    const t = setTimeout(() => navigate("/onboarding-cora"), 2000);
  ...
  return (
    ...
    >
      ...
      >
        <Component01OnboardingCoraIntro />
      </div>
    </div>
  );
}
